...
COCO_MODEL_PATH = '/home/yuanye/Moun/2_p1_2018_19/maskRCNN-torch/models/mask_rcnn_coco.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--command', required=False, default='train',
                        metavar="<command>",
                        help="'train' or 'evaluate' on MS COCO")
    parser.add_argument('--dataset', required=False, default='/home/yuanye/Moun/COCO',
    ...
    parser.add_argument('--model', required=False,
                        default='/home/yuanye/Moun/2_p1_2018_19/maskRCNN-torch/models/resnet50_imagenet.pth',
