# Mask-RCNN-pytorch
Pytorch implementation of Mask RCNN Training on COCO2014 With PyTorch0.4.0

论文地址： [Mask R-CNN](https://arxiv.org/abs/1703.06870v1)

工程原址： [github链接](https://github.com/multimodallearning/pytorch-mask-rcnn)

论文解读： [CSDN博客](https://blog.csdn.net/kevin_zhao_zl/article/details/86488836)
...
* Ubuntu18.08+cuda9.0
* Using Pycharm
* Modify your path in the code. including COCO-dir,loss-pic -dir, etc
******
# pytorch-mask-rcnn
